...
func TestResolveVersion(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.description, func(t *testing.T) {
			...
			found := filterPackages(pkgs, &disqualified{reasons: map[*RepositoryPackage]string{}}, withVersion(tt.version, tt.compare), withPreferPin(tt.pin), withInstalledPackage(tt.installed))
